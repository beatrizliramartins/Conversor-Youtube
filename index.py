...
app_nome = Label(frame_principal, text="YouTube Downloader app", width=45, height=10, padx=0, relief="flat", anchor="nw", font=('Ivy 15 bold'), bg=fundo, fg=co1)
app_nome.place(x=75, y=23)
...
e_url = Entry(frame_principal, width=45, justify='left',relief=SOLID)
...
b_download = Button(frame_quadros, image=down, bg=fundo, fg=co1,font=('Ivy 10 bold'), relief=FLAT, overrelief=RIDGE, command=download, background='#FFFFFF')
b_download.place(x=460, y=0)
